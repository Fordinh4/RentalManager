...
public class UserService implements IUserService {
    ...
    public Map<Long, String> getStaffs() {
        ...
        // tìm tại repo user nhưng dựa vào bảng N:N giữa user và role và trong repo role có code nên lấy nó để check lun
        // cái roles ở userEntity nó trả 1 cái list nên khai báo bằng biến đó trc
        // kiểm tra có bị khóa mềm bằng status không và tìm mỗi user là STAFF th
